...
import {faAward, faLocationDot, faPeopleGroup, faUserPlus,} from "@fortawesome/free-solid-svg-icons";
                ...
                <Row className="card-top">
                    ...
                    <Col>
                        ...
                        <Row>
                            ...
                            <p className="participant-list-container" onClick={() => {
                                handleShowParticipantsModal();
                                ...
                                })}
                                {
                                    ...
                                    <img className="participant-profile-image" src={ellipsis} title="more"/>
                                }
