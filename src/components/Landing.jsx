...
import {addNewUser, clearDatabase, signInWithGoogle, useAuthState,} from "../utilities/firebase";
...
const Landing = (allUsers) => {
    ...
    useEffect(() => {
        toast.warning("Access to write features for this project is currently disabled, which may impact certain functionalities. To request access restoration, please reach out to the development team.",{
        ...
        <>
            ...
            <div className="landing-page-container">
                ...
                <div className="col-right">
                    ...
                    <h3 className="blurb">
                        We help students create or join sporting events that pique their
                        interests!
                    </h3>
                    <SignInButton/>
                    {/*<ClearDBButton />*/}
